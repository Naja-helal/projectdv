...
export default function EditExpectedExpenseForm({ expense, open, onClose }: EditExpectedExpenseFormProps) {
    ...
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="w-full max-w-lg max-h-[95vh] overflow-y-auto m-0 sm:m-6 rounded-none sm:rounded-lg">
        <DialogHeader className="pb-4">
          <DialogTitle className="text-xl font-bold text-center">تحرير الإنفاق المتوقع</DialogTitle>
          <DialogDescription className="text-center text-gray-600">
            تحديث تفاصيل الإنفاق المتوقع
          </DialogDescription>
        </DialogHeader>
